...
<style>
    /* Fix button contrast on dark background - increased specificity */
    section.td-box--1 a.btn-primary,
    .td-box--1 > .container a.btn.btn-primary {
        background-color: #ffffff !important;
        border-color: #ffffff !important;
        color: #2C5F8D !important;
        font-weight: 600 !important;
    }
    section.td-box--1 a.btn-primary:hover,
    .td-box--1 > .container a.btn.btn-primary:hover {
        background-color: #f0f0f0 !important;
        border-color: #f0f0f0 !important;
        color: #1a3a52 !important;
    }
    section.td-box--1 a.btn-secondary,
    .td-box--1 > .container a.btn.btn-secondary {
        background-color: #FFA500 !important;
        border-color: #FFA500 !important;
        color: #ffffff !important;
        font-weight: 600 !important;
    }
    section.td-box--1 a.btn-secondary:hover,
    .td-box--1 > .container a.btn.btn-secondary:hover {
