            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-body text-center p-4">
                        ...
                        <div class="my-4">
                            <div class="demo-screenshot bg-light p-5 d-flex align-items-center justify-content-center" style="min-height: 250px; border: 2px dashed #dee2e6;">
                                <div class="text-center text-muted">
                                    <i class="fas fa-image fa-4x mb-3"></i>
                                    <p class="mb-0">Web Interface Preview</p>
                                    <p class="small">Browse documentation structure visually</p>
                                </div>
                            </div>
                        </div>
