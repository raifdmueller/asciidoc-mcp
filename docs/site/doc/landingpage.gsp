...
<section class="row td-box td-box--1 position-relative td-box--gradient td-box--height-auto">
    <div class="container text-center td-arrow-down">
        ...
        <!-- Badges -->
        <div class="pt-3">
            <img src="https://img.shields.io/github/stars/raifdmueller/asciidoc-mcp?style=social" alt="GitHub stars" class="me-2">
            <img src="https://img.shields.io/github/license/raifdmueller/asciidoc-mcp" alt="License" class="me-2">
            <img src="https://img.shields.io/badge/coverage-82%25-brightgreen" alt="Coverage" class="me-2">
            <img src="https://img.shields.io/badge/python-3.11%2B-blue" alt="Python 3.11+" class="me-2">
        </div>

        <div class="pt-4 pb-5">
            <a class="btn btn-lg btn-primary me-3 mb-2" href="https://github.com/raifdmueller/asciidoc-mcp">
                <i class="fab fa-github"></i> View on GitHub
            </a>
            <a class="btn btn-lg btn-secondary mb-2" href="${content.rootpath}arc42-template.html">
